...
<div class="row">
    <div class="col-md-12">
        ...
        @endif
        <form class="forms-sample" class="repeater" action="{{ route('admin.purchase.invoice.update', $invoice->id) }}" method="POST">
            <div class="card ">
                <div class="card-body">
                    @csrf
                    @method('patch')
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="date" id="date" value="{{ $invoice->date }}"
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="code" value="{{ $invoice->code }}" 
                                    class="form-control" disabled>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="order_id" value="{{ $invoice->order->code }}"
                                    class="form-control" disabled>
                            </div>
                        </div>
                    </div>
...
<script>
    const invoicedetail_url = '{{ route('api.get-buy-invoice.details', ':id') }}';
    ...
    $(document).ready(function () {
        ...
        $('#add').click(function () {
            field_dinamis_edit('invoices', url_product);
            checkRowLength();
        })
