    ...
    <div class="col-lg-12 col-md-12 col-12">
        <div class="card card-payment">
            <div class="card-header py-2 d-flex justify-content-between align-items-center">
                <a href="{{ route('admin.purchase.invoice.create') }}" class="btn btn-sm btn-primary shadow">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item"
                                                href="{{ route('admin.purchase.invoice.show', $invoice->id) }}">
                                                <i data-feather="eye"></i>
                                                <span class="ml-1">@lang('Show')</span>
                                            </a>
                                            <a class="dropdown-item" href="{{ route('admin.purchase.invoice.edit', $invoice->id) }}">
                                            ...
                                            <form id="form-delete{{ $invoice->id }}" action="{{ route('admin.purchase.invoice.destroy', $invoice->id) }}" method="POST">
                                                @csrf
                                                @method('delete')
                                            </form>
                                        </div>
