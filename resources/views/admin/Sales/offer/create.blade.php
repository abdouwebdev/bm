...
<li class="breadcrumb-item" aria-current="page">@lang('ADD') @lang('Offer')</li>
@endpush
@section('content')
<div class="row">
    <div class="col-md-12">
        ...
        @endif
        <form class="forms-sample" class="repeater" action="{{ route('admin.sales.offer.store') }}" method="POST">
            <div class="card ">
                <div class="card-body">
                    @csrf
    ...
    function field_dinamis() {
            ...
            let html = `
                <tr class="rowComponent">
                    <input type="hidden" width="10px" name="offers[${index}][id]" value="${uuid}">
                    <td class="no" hidden>
                    ...
                    <td>
                        <input type="text" name="offers[${index}][amount]"  class="form-control amount" placeholder="0" readonly>
                    </td>
                    <td>
                    ...
                    <td>
                        <input type="text" name="offers[${index}][total]" class="form-control total"  placeholder="0" readonly>
                    </td>
                    <td>
            ...
            $('[name="offers['+index+'][amount]"]').on('change', function () {
                const price = $('[name="offers['+index+'][price]"]').val();
