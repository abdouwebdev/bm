...
<div class="row">
    <div class="col-md-12">
        ...
        @endif
        <form class="forms-sample" class="repeater" action="{{ route('admin.sales.invoice.store') }}" method="POST">
            <div class="card ">
                <div class="card-body">
                    @csrf
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#order_id").select2({
            ...
            ajax: {
                url: '{{ route('admin.get-sale-order') }}',
                type: 'post',
                dataType: 'json',
                data: params => {
                    return {
    ...
    function field_dinamis() {
        ...
        let html = `
                <tr class="rowComponent">
                    <input type="hidden" width="10px" name="invoices[${index}][id]" value="${uuid}">
                    <td class="no" hidden>
                    ...
                    <td>
                        <input type="text" name="invoices[${index}][amount]" class="form-control amount" placeholder="0" readonly>
                    </td>
                    <td>
                    ...
                    <td>
                        <input type="text" name="invoices[${index}][total]" class="form-control total"  placeholder="0" readonly>
                    </td>
            `
