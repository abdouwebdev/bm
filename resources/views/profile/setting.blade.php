...
@section('title', 'Setting')
    @push('breadcrumb')
        <li class="breadcrumb-item">
            <a href="{{ route('profile.setting') }}">@lang('Account Settings')</a>
        </li>
    @endpush
@section('content')
    ...
    <ul class="nav nav-pills flex-column nav-left">
      ...
      <li class="nav-item">
        ...
        >
          ...
          <span class="font-weight-bold">@lang('General')</span>
        </a>
      </li>
      <!-- change password -->
      <li class="nav-item">
        ...
        >
          ...
          <span class="font-weight-bold">@lang('Change Password')</span>
        </a>
      </li>
    </ul>
  </div>
          ...
          >
            ...
            <form class="validate-form mt-2" action="{{ route('profile.update') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="media">
                    ...
                    <p>Format png, jpg, jpeg, ico, svg</p>
                    </div>
                    <!--/ upload and reset button -->
                </div>
                <!--/ header media -->
              ...
              <div class="row">
                <div class="col-12 col-sm-6">
                  <div class="form-group">
                    <label for="account-username">@lang('Username')</label>
                    <input type="text" id="username" name="username" value="{{ auth()->user()->username ?? old('username') }}"
                        placeholder="@lang('Username')" class="form-control @error('username') is-invalid @enderror">
                        @error('username')
                ...
                <div class="col-12 col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" value="{{ auth()->user()->name ?? old('name') }}"
                        placeholder="@lang('Name')" class="form-control @error('name') is-invalid @enderror">
                        @error('name')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="col-12">
                  <button type="submit" class="btn btn-primary mt-2 mr-1">@lang('Save changes')</button>
                  <button type="reset" class="btn btn-outline-secondary mt-2">@lang('Cancel')</button>
                </div>
              </div>
            </form>
            <!--/ form -->
          ...
          >
            ...
            <form class="validate-form" action="{{ route('password.edit') }}" method="post">
              ...
              <div class="row">
                <div class="col-12 col-sm-6">
                  <div class="form-group">
                    <label for="account-old-password">@lang('Old Password')</label>
              ...
              <div class="row">
                ...
                <div class="col-12 col-sm-6">
                  <div class="form-group">
                    <label for="account-retype-new-password">@lang('Retype New Password')</label>
                    <div class="input-group form-password-toggle input-group-merge">
                ...
                <div class="col-12">
                  <button type="submit" class="btn btn-primary mr-1 mt-1">@lang('Save changes')</button>
