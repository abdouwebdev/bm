...
<head>
    ...
    <meta name="description" content="BUDGET MAGAL TOUBA ">
    <meta name="keywords" content="Crm Budget Magal Touba, Banque Compte">
    <meta name="author" content="Mouritech">
    <title>Login | Budget Magal</title>

    <link rel="icon" href="{{ asset ('img/logobm.png') }}">
